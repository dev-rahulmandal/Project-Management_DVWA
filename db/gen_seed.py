...
NEW_ORGS = [  # (id, name, slug, plan)
    (3, "Initech", "initech", "pro"),
    (4, "Hooli", "hooli", "enterprise"),
    (5, "Umbrella Co", "umbrella", "starter"),
    (6, "Stark Industries", "stark", "enterprise"),
    (7, "Wayne Enterprises", "wayne", "pro"),
    (8, "Cyberdyne Systems", "cyberdyne", "starter"),
]
ORG_SLUG = {1: "acme", 2: "globex", **{o[0]: o[2] for o in NEW_ORGS}}
