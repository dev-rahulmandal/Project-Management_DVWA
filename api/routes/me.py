...
async def get_me(user: dict = Depends(require_auth)):
    ...
    # The over-exposing variant (BOPLA vuln) is a separate, manifested endpoint.
    return {
        "id": user["id"],
        "email": user["email"],
...
# Change own password. Secure baseline: the CURRENT password is required and
# verified before the change is allowed.
