"""
Task detail, updates, and comments. Org-scoped, field-validated (secure
baseline). Project-scoped task list/create stays in routes/projects.py.
"""
import aiosqlite
...
# --------------------- Org-wide task board (filterable) -----------------------
...
async def list_tasks(
    ...
    # Org-scoped, correctly secured: only the caller's org, excluding soft-deleted.
