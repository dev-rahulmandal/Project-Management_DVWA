...
// WEB-XSS-001-SAFE (secured twin): the SAME stored task bodies as the vulnerable
// /projects/[id] view, but rendered via <TaskRows> WITHOUT `unsafe` - React
// escapes the body, so an <img onerror> / <script> payload is shown as inert
// text and never executes. Unlinked, like the /api/secure/* controls.
