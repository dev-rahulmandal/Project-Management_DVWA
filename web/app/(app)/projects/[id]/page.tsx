...
export default function ProjectDetailPage() {
  ...
  // Tasks - benign, org-scoped (empty for a project outside your org).
  ...
  useEffect(() => {
    ...
    // Project header - hits GET /api/projects/{id} (the vulnerable detail route).
      ...
      {project && (
        <>
          ...
          <section className="mt-8">
            ...
            {/* WEB-XSS-001: task bodies rendered as raw HTML ("rich-text notes"). */}
            {tasks && <TaskRows tasks={tasks} unsafe />}
          </section>
