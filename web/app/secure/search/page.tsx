...
// WEB-DOMXSS-001-SAFE (secured twin): the SAME URL-fragment value as /search,
// but written with textContent instead of innerHTML, so any markup is shown as
// inert text and never executes.
