...
// WEB-SECRET-001-SAFE (secured twin): only a PUBLISHABLE key lives client-side
// (safe to ship). Any operation needing the secret is performed on the server,
// so the secret never enters the bundle.
...
export default function SecurePricingPage() {
  useEffect(() => {
    // Only the publishable key is used client-side; the server holds the secret.
