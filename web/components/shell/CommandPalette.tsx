...
/** ⌘K / Ctrl-K command palette. Searches navigation + the org's projects,
 *  tasks and people; selecting one routes to it. Opened by the keyboard
 *  shortcut or a `vf-open-command` window event (fired by the topbar button). */
export function CommandPalette() {
  ...
  // Build the search index the first time the palette is opened.
  useEffect(() => {
